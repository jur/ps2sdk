...
#define __GS_PRIVILEGED_H__
 ...
 #define GS_REG_PMODE		0x12000000	// PCRTC Mode Setting
 #define GS_REG_SMODE1		0x12000010	// VHP,VCKSEL,SLCK2,NVCK,CLKSEL,PEVS,PEHS,PVS,PHS,GCONT,SPML,PCK2,XPCK,SINT,PRST,EX,CMOD,SLCK,T1248,LC,RC
 #define GS_REG_SMODE2		0x12000020	// Setting For Modes Related to Video Synchronization
 #define GS_REG_SRFSH		0x12000030	// DRAM Refresh Settings
 #define GS_REG_SYNCH1		0x12000040	// HS,HSVS,HSEQ,HBP,HFP
 #define GS_REG_SYNCH2		0x12000050	// HB,HF
 #define GS_REG_SYNCHV		0x12000060	// VS,VDP,VBPE,VBP,VFPE,VFP
 #define GS_REG_DISPFB1		0x12000070	// Setting For Rectangular Area Read Output Circuit 1
 #define GS_REG_DISPLAY1	0x12000080	// Setting For Rectangular Area Read Output Circuit 1
 #define GS_REG_DISPFB2		0x12000090	// Setting For Rectangular Area Read Output Circuit 2
 #define GS_REG_DISPLAY2	0x120000A0	// Setting For Rectangular Area Read Output Circuit 2
 #define GS_REG_EXTBUF		0x120000B0	// Setting For Feedback Buffer Write Buffer
 #define GS_REG_EXTDATA		0x120000C0	// Feedback Write Setting
 #define GS_REG_EXTWRITE	0x120000D0	// Feedback Write Function Control
 #define GS_REG_BGCOLOR		0x120000E0	// Background Color Setting
 #define GS_REG_CSR		0x12001000	// System Status
 #define GS_REG_IMR		0x12001010	// Interrupt Mask Control
 #define GS_REG_BUSDIR		0x12001040	// Host I/F Bus Switching
 #define GS_REG_SIGLBLID	0x12001080	// Signal ID Value Read
