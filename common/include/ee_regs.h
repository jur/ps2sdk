...
#define R_EE_T0_COUNT _lw(A_EE_T0_COUNT)
// Timer 0 mode/status
#define R_EE_T0_MODE _lw(A_EE_T0_MODE)
// Timer 0 compare value
#define R_EE_T0_COMP _lw(A_EE_T0_COMP)
// Timer 0 hold value
#define R_EE_T0_HOLD _lw(EE_T0_HOLD)
// Timer 1 counter value
#define R_EE_T1_COUNT _lw(A_EE_T1_COUNT)
// Timer 1 mode/status
#define R_EE_T1_MODE _lw(A_EE_T1_MODE)
// Timer 1 compare value
#define R_EE_T1_COMP _lw(A_EE_T1_COMP)
// Timer 1 hold value
#define R_EE_T1_HOLD _lw(A_EE_T1_HOLD)
// Timer 2 counter value
#define R_EE_T2_COUNT _lw(A_EE_T2_COUNT)
// Timer 2 mode/status
#define R_EE_T2_MODE _lw(A_EE_T2_MODE)
// Timer 2 compare value
#define R_EE_T2_COMP _lw(A_EE_T2_COMP)
// Timer 3 counter value
#define R_EE_T3_COUNT _lw(A_EE_T3_COUNT)
// Timer 3 mode/status
#define R_EE_T3_MODE _lw(A_EE_T3_MODE)
// Timer 3 compare value
#define R_EE_T3_COMP _lw(A_EE_T3_COMP)
// IPU command
#define R_EE_IPU_CMD _lw() A_EE_IPU_CMD)
// IPU control
#define R_EE_IPU_CTRL _lw(A_EE_IPU_CTRL)
// IPU input FIFO control
#define R_EE_IPU_BP _lw(A_EE_IPU_BP)
// First data of bit stream
#define R_EE_IPU_TOP _ld(A_EE_IPU_TOP)
// GIF control
#define R_EE_GIF_CTRL _lw(A_EE_GIF_CTRL)
// GIF mode setting
#define R_EE_GIF_MODE _lw(A_EE_GIF_MODE)
// GIF status
#define R_EE_GIF_STAT _lw(A_EE_GIF_STAT)
// GIFtag ((vu32 *) bits 31-0) immediately before
#define R_EE_GIF_TAG0 _lw(A_EE_GIF_TAG0)
// GIFtag ((vu32 *) bits 63-32) immediately before
#define R_EE_GIF_TAG1 _lw(A_EE_GIF_TAG1)
// GIFtag ((vu32 *) bits 95-64) immediately before
#define R_EE_GIF_TAG2 _lw(A_EE_GIF_TAG2)
// GIFtag ((vu32 *) bits 127-96) immediately before
#define R_EE_GIF_TAG3 _lw(A_EE_GIF_TAG3)
// Transfer status counter
#define R_EE_GIF_CNT _lw(A_EE_GIF_CNT)
// PATH3 transfer status counter
#define R_EE_GIF_P3CNT _lw(A_EE_GIF_P3CNT)
// PATH3 tag value
#define R_EE_GIF_P3TAG _lw(A_EE_GIF_P3TAG)
// Status
#define R_EE_VIF0_STAT _lw(A_EE_VIF0_STAT)
// Operation control
#define R_EE_VIF0_FBRST _lw(A_EE_VIF0_FBRST)
// Error status
#define R_EE_VIF0_ERR _lw(A_EE_VIF0_ERR)
// Mark value
#define R_EE_VIF0_MARK _lw(A_EE_VIF0_MARK)
// Data write cycle
#define R_EE_VIF0_CYCLE _lw(A_EE_VIF0_CYCLE)
// ADD mode
#define R_EE_VIF0_MODE _lw(A_EE_VIF0_MODE)
// Amount of non-transferred data
#define R_EE_VIF0_NUM _lw(A_EE_VIF0_NUM)
// Write mask pattern
#define R_EE_VIF0_MASK _lw(A_EE_VIF0_MASK)
// Last processed VIFcode
#define R_EE_VIF0_CODE _lw(A_EE_VIF0_CODE)
// Next ITOP value
#define R_EE_VIF0_ITOPS _lw(A_EE_VIF0_ITOPS)
// ITOP value
#define R_EE_VIF0_ITOP _lw(A_EE_VIF0_ITOP)
// Filling data R0 ((vu32 *) Row register)
#define R_EE_VIF0_R0 _lw(A_EE_VIF0_R0)
// Filling data R1 ((vu32 *) Row register)
#define R_EE_VIF0_R1 _lw(A_EE_VIF0_R1)
// Filling data R2 ((vu32 *) Row register)
#define R_EE_VIF0_R2 _lw(A_EE_VIF0_R2)
// Filling data R3 ((vu32 *) Row register)
#define R_EE_VIF0_R3 _lw(A_EE_VIF0_R3)
// Filling data C0 ((vu32 *) Col register)
#define R_EE_VIF0_C0 _lw(A_EE_VIF0_C0)
// Filling data C1 ((vu32 *) Col register)
#define R_EE_VIF0_C1 _lw(A_EE_VIF0_C1)
// Filling data C2 ((vu32 *) Col register)
#define R_EE_VIF0_C2 _lw(A_EE_VIF0_C2)
// Filling data C3 ((vu32 *) Col register)
#define R_EE_VIF0_C3 _lw(A_EE_VIF0_C3)
// Status
#define R_EE_VIF1_STAT _lw(A_EE_VIF1_STAT)
// Operation control
#define R_EE_VIF1_FBRST _lw(A_EE_VIF1_FBRST)
// Error status
#define R_EE_VIF1_ERR _lw(A_EE_VIF1_ERR)
// Mark value
#define R_EE_VIF1_MARK _lw(A_EE_VIF1_MARK)
// Data write cycle
#define R_EE_VIF1_CYCLE _lw(A_EE_VIF1_CYCLE)
// ADD mode
#define R_EE_VIF1_MODE _lw(A_EE_VIF1_MODE)
// Amount of non-transferred data
#define R_EE_VIF1_NUM _lw(A_EE_VIF1_NUM)
// Write mask pattern
#define R_EE_VIF1_MASK _lw(A_EE_VIF1_MASK)
// Last processed VIFcode
#define R_EE_VIF1_CODE _lw(A_EE_VIF1_CODE)
// Next ITOP value
#define R_EE_VIF1_ITOPS _lw(A_EE_VIF1_ITOPS)
// Base address of double buffer
#define R_EE_VIF1_BASE _lw(A_EE_VIF1_BASE)
// Offset of double buffer
#define R_EE_VIF1_OFST _lw(A_EE_VIF1_OFST)
// Next TOP value/data write address
#define R_EE_VIF1_TOPS _lw(A_EE_VIF1_TOPS)
// ITOP value
#define R_EE_VIF1_ITOP _lw(A_EE_VIF1_ITOP)
// TOP value
#define R_EE_VIF1_TOP _lw(A_EE_VIF1_TOP)
// Filling data R0 ((vu32 *) Row register)
#define R_EE_VIF1_R0 _lw(A_EE_VIF1_R0)
// Filling data R1 _lw((vu32 *) Row register)
#define R_EE_VIF1_R1 _lw(A_EE_VIF1_R1)
// Filling data R2 ((vu32 *) Row register)
#define R_EE_VIF1_R2 _lw(A_EE_VIF1_R2)
// Filling data R3 ((vu32 *) Row register)
#define R_EE_VIF1_R3 _lw(A_EE_VIF1_R3)
// Filling data C0 ((vu32 *) Col register)
#define R_EE_VIF1_C0 _lw(A_EE_VIF1_C0)
// Filling data C1 ((vu32 *) Col register)
#define R_EE_VIF1_C1 _lw(A_EE_VIF1_C1)
// Filling data C2 ((vu32 *) Col register)
#define R_EE_VIF1_C2 _lw(A_EE_VIF1_C2)
// Filling data C3 ((vu32 *) Col register)
#define R_EE_VIF1_C3 _lw(A_EE_VIF1_C3)
// VIF0 FIFO ((vu32 *) write)
#define R_EE_VIF0_FIFO _lw(A_EE_VIF0_FIFO)
// VIF1 FIFO ((vu32 *) read/write)
#define R_EE_VIF1_FIFO _lw(EE_VIF1_FIFO)
// GIF FIFO ((vu32 *) write)
#define R_EE_GIF_FIFO _lw(A_EE_GIF_FIFO)
// IPU FIFO ((vu32 *) read)
#define R_EE_IPU_out_FIFO _lw(A_EE_IPU_out_FIFO)
// IPU FIFO ((vu32 *) write)
#define R_EE_IPU_in_FIFO _lw(A_EE_IPU_in_FIFO)
// Ch0 channel control
#define R_EE_D0_CHCR _lw(A_EE_D0_CHCR)
// Ch0 memory address
#define R_EE_D0_MADR _lw(A_EE_D0_MADR)
// Ch0 quad word count
#define R_EE_D0_QWC _lw(A_EE_D0_QWC)
// Ch0 tag address
#define R_EE_D0_TADR _lw(A_EE_D0_TADR)
// Ch0 address stack 0
#define R_EE_D0_ASR0 _lw(A_EE_D0_ASR0)
// Ch0 address stack 1
#define R_EE_D0_ASR1 _lw(A_EE_D0_ASR1)
// Ch1 channel control
#define R_EE_D1_CHCR _lw(A_EE_D1_CHCR)
// Ch1 memory address
#define R_EE_D1_MADR _lw(A_EE_D1_MADR)
// Ch1 quad word count
#define R_EE_D1_QWC _lw(A_EE_D1_QWC)
// Ch1 tag address
#define R_EE_D1_TADR _lw(A_EE_D1_TADR)
// Ch1 address stack 0
#define R_EE_D1_ASR0 _lw(A_EE_D1_ASR0)
// Ch1 address stack 1
#define R_EE_D1_ASR1 _lw(A_EE_D1_ASR1)
// Ch2 channel control
#define R_EE_D2_CHCR _lw(A_EE_D2_CHCR)
// Ch2 memory address
#define R_EE_D2_MADR _lw(A_EE_D2_MADR)
// Ch2 quad word count
#define R_EE_D2_QWC _lw(A_EE_D2_QWC)
// Ch2 tag address
#define R_EE_D2_TADR _lw(A_EE_D2_TADR)
// Ch2 address stack 0
#define R_EE_D2_ASR0 _lw(A_EE_D2_ASR0)
// Ch2 address stack 1
#define R_EE_D2_ASR1 _lw(A_EE_D2_ASR1)
// Ch3 channel control
#define R_EE_D3_CHCR _lw(A_EE_D3_CHCR)
// Ch3 memory address
#define R_EE_D3_MADR _lw(A_EE_D3_MADR)
// Ch3 quad word count
#define R_EE_D3_QWC _lw(A_EE_D3_QWC)
// Ch4 chnnel control
#define R_EE_D4_CHCR _lw(A_EE_D4_CHCR)
// Ch4 memory address
#define R_EE_D4_MADR _lw(A_EE_D4_MADR)
// Ch4 quad word count
#define R_EE_D4_QWC _lw(A_EE_D4_QWC)
// Ch4 tag address
#define R_EE_D4_TADR _lw(A_EE_D4_TADR)
// Ch5 channel control
#define R_EE_D5_CHCR _lw(A_EE_D5_CHCR)
// Ch5 memory address
#define R_EE_D5_MADR _lw(A_EE_D5_MADR)
// Ch5 quad word count
#define R_EE_D5_QWC _lw(A_EE_D5_QWC)
// Ch6 channel control
#define R_EE_D6_CHCR _lw(A_EE_D6_CHCR)
// Ch6 memory address
#define R_EE_D6_MADR _lw(A_EE_D6_MADR)
// Ch6 quad word count
#define R_EE_D6_QWC _lw(A_EE_D6_QWC)
// Ch6 tag address
#define R_EE_D6_TADR _lw(A_EE_D6_TADR)
// Ch7 channel control
#define R_EE_D7_CHCR _lw(A_EE_D7_CHCR)
// Ch7 memory address
#define R_EE_D7_MADR _lw(A_EE_D7_MADR)
// Ch7 quad word count
#define R_EE_D7_QWC _lw(A_EE_D7_QWC)
// Ch8 channel control
#define R_EE_D8_CHCR _lw(A_EE_D8_CHCR)
// Ch8 memory address
#define R_EE_D8_MADR _lw(A_EE_D8_MADR)
// Ch8 quad word count
#define R_EE_D8_QWC _lw(A_EE_D8_QWC)
// Ch8 SPR address
#define R_EE_D8_SADR _lw(A_EE_D8_SADR)
// Ch9 channel control
#define R_EE_D9_CHCR _lw(A_EE_D9_CHCR)
// Ch9 memory address
#define R_EE_D9_MADR _lw(A_EE_D9_MADR)
// Ch9 quad word count
#define R_EE_D9_QWC _lw(A_EE_D9_QWC)
// Ch9 tag address
#define R_EE_D9_TADR _lw(A_EE_D9_TADR)
// Ch9 SPR address
#define R_EE_D9_SADR _lw(A_EE_D9_SADR)
// DMAC control
#define R_EE_D_CTRL _lw(A_EE_D_CTRL)
// DMAC status
#define R_EE_D_STAT _lw(A_EE_D_STAT)
// DMAC priority control
#define R_EE_D_PCR _lw(A_EE_D_PCR)
// DMAC skip quad word
#define R_EE_D_SQWC _lw(A_EE_D_SQWC)
// DMAC ring buffer size
#define R_EE_D_RBSR _lw(A_EE_D_RBSR)
// DMAC ring buffer offset
#define R_EE_D_RBOR _lw(A_EE_D_RBOR)
// DMA stall address
#define R_EE_D_STADR _lw(A_EE_D_STADR)
// Interrupt status
#define R_EE_I_STAT _lw(A_EE_I_STAT)
// Interrupt mask
#define R_EE_I_MASK _lw(A_EE_I_MASK)


// EE SIO Line Control Register
#define R_EE_SIO_LCR _lw(A_EE_SIO_LCR)
// EE SIO Line Status Register
#define R_EE_SIO_LSR _lw(A_EE_SIO_LSR)
// EE SIO Interrupt Enable Register
#define R_EE_SIO_IER _lw(A_EE_SIO_IER)
// EE SIO Interrupt Status Register
#define R_EE_SIO_ISR _lw(A_EE_SIO_ISR)
// EE SIO FIFO Control Register
#define R_EE_SIO_FCR _lw(A_EE_SIO_FCR)
// EE SIO Baud Rate Control Register
#define R_EE_SIO_BRC _lw(A_EE_SIO_BRC)
// Unknown SIO Register 0x60
#define R_EE_SIO_REG60 _lb(A_EE_SIO_REG60)
// Unknown SIO Register 0x70
#define R_EE_SIO_REG70 _lb(A_EE_SIO_REG70)
// Transfer Holding Register
#define R_EE_SIO_TXFIFO _lb(A_EE_SIO_TXFIFO)
// Unknown SIO Register 0x90
#define R_EE_SIO_REG90 _lb(A_EE_SIO_REG90)
// Unknown SIO Register 0xA0
#define R_EE_SIO_REGA0 _lb(A_EE_SIO_REGA0)
// Unknown SIO Register 0xB0
#define R_EE_SIO_REGB0 _lb(A_EE_SIO_REGB0)
// Recieve Buffer Register
#define R_EE_SIO_RXFIFO _lb(A_EE_SIO_RXFIFO)

// SBUS Unknown Reg 0x00
#define R_EE_SBUS_MADDR _lw(A_EE_SBUS_REG00)
// SBUS Unknown Reg 0x10
#define R_EE_SBUS_SADDR _lw(A_EE_SBUS_REG10)
// SBUS Main -> Sub Flag
#define R_EE_SBUS_MSFLAG _lw(A_EE_SBUS_MSFLAG)
// SBUS Sub -> Main Flag
#define R_EE_SBUS_SMFLAG _lw(A_EE_SBUS_SMFLAG)
// SBUS Unknown Reg 0x40
#define R_EE_SBUS_REG40 _lw(A_EE_SBUS_REG40)
// SBUS Unknown Reg 0x50
#define R_EE_SBUS_REG50 _lw(A_EE_SBUS_REG50)
// SBUS Unknown Reg 0x60
#define R_EE_SBUS_REG60 _lw(A_EE_SBUS_REG60)
// SBUS Unknown Reg 0x70
#define R_EE_SBUS_REG70 _lw(A_EE_SBUS_REG70)
// SBUS Unknown Reg 0x80
#define R_EE_SBUS_REG80 _lw(A_EE_SBUS_REG80)
// SBUS Unknown Reg 0x90
#define R_EE_SBUS_REG90 _lw(A_EE_SBUS_REG90)
// SBUS Unknown Reg 0xA0
#define R_EE_SBUS_REGA0 _lw(A_EE_SBUS_REGA0)
// SBUS Unknown Reg 0xB0
#define R_EE_SBUS_REGB0 _lw(A_EE_SBUS_REGB0)
// SBUS Unknown Reg 0xC0
#define R_EE_SBUS_REGC0 _lw(A_EE_SBUS_REGC0)
// SBUS Unknown Reg 0xD0
#define R_EE_SBUS_REGD0 _lw(A_EE_SBUS_REGD0)
// SBUS Unknown Reg 0xE0
#define R_EE_SBUS_REGE0 _lw(A_EE_SBUS_REGE0)
// SBUS Unknown Reg 0xF0
#define R_EE_SBUS_REGF0 _lw(A_EE_SBUS_REGF0)

// PGIF GPU Status
#define R_EE_PGIF_GPU_STAT _lw(A_EE_PGIF_GPU_STAT)
// PGIF Unknown Reg 0x10
#define R_EE_PGIF_REG10 _lw(A_EE_PGIF_REG10)
// PGIF Unknown Reg 0x20
#define R_EE_PGIF_REG20 _lw(A_EE_PGIF_REG20)
// PGIF Unknown Reg 0x30
#define R_EE_PGIF_REG30 _lw(A_EE_PGIF_REG30)
// PGIF Unknown Reg 0x40
#define R_EE_PGIF_REG40 _lw(A_EE_PGIF_REG40)
// PGIF Unknown Reg 0x50
#define R_EE_PGIF_REG50 _lw(A_EE_PGIF_REG50)
// PGIF Unknown Reg 0x60
#define R_EE_PGIF_REG60 _lw(A_EE_PGIF_REG60)
// PGIF Unknown Reg 0x70
#define R_EE_PGIF_REG70 _lw(A_EE_PGIF_REG70)
// PGIF GPU Command FIFO Status
#define R_EE_PGIF_CFIFO_STAT _lw(A_EE_PGIF_CFIFO_STAT)
// PGIF Unknown Reg 0x90
#define R_EE_PGIF_REG90 _lw(A_EE_PGIF_REG90)
// PGIF Unknown Reg 0xA0
#define R_EE_PGIF_REGA0 _lw(A_EE_PGIF_REGA0)
// PGIF Unknown Reg 0xB0
#define R_EE_PGIF_REGB0 _lw(A_EE_PGIF_REGB0)
// PGIF GPU Command FIFO Data
#define R_EE_PGIF_CFIFO_DATA _lw(A_EE_PGIF_CFIFO_DATA)
// PGIF Unknown Reg 0xD0
#define R_EE_PGIF_REGD0 _lw(A_EE_PGIF_REGD0)
// PGIF Unknown Reg 0xE0
#define R_EE_PGIF_REGE0 _lw(A_EE_PGIF_REGE0)
// PGIF Unknown Reg 0xF0
#define R_EE_PGIF_REGF0 _lw(A_EE_PGIF_REGF0)
// Acquisition of DMA suspend status
#define R_EE_D_ENABLER _lw(A_EE_D_ENABLER)
// DMA suspend control
#define R_EE_D_ENABLEW _lw(A_EE_D_ENABLEW)

// EE GS Registers

// Various PCRTC modes
#define R_EE_GS_PMODE _ld(A_EE_GS_PMODE)
// Related to Sync
#define R_EE_GS_SMODE1 _ld(A_EE_GS_SMODE1)
// Related to Sync
#define R_EE_GS_SMODE2 _ld(A_EE_GS_SMODE2)
// DRAM refresh
#define R_EE_GS_SRFSH _ld(A_EE_GS_SRFSH)
// Related to Sync
#define R_EE_GS_SYNCH1 _ld(A_EE_GS_SYNCH1)
// Related to Sync
#define R_EE_GS_SYNCH2 _ld(A_EE_GS_SYNCH2)
// Related to Sync/start
#define R_EE_GS_SYNCV _ld(A_EE_GS_SYNCV)
// Related to display buffer of Rectangular Area 1
#define R_EE_GS_DISPFB1 _ld(A_EE_GS_DISPFB1)
// Rectangular Area 1 display position etc.
#define R_EE_GS_DISPLAY1 _ld(A_EE_GS_DISPLAY1)
// Related to display buffer of Rectangular Area 2
#define R_EE_GS_DISPFB2 _ld(A_EE_GS_DISPFB2)
// Rectangular Area 2 display position etc.
#define R_EE_GS_DISPLAY2 _ld(A_EE_GS_DISPLAY2)
// Rectangular area write buffer
#define R_EE_GS_EXTBUF _ld(A_EE_GS_EXTBUF)
// Rectangular area write data
#define R_EE_GS_EXTDATA _ld(A_EE_GS_EXTDATA)
// Rectangular area write start
#define R_EE_GS_EXTWRITE _ld(A_EE_GS_EXTWRITE)
// Background color
#define R_EE_GS_BGCOLOR _ld(A_EE_GS_BGCOLOR)
// Various GS status
#define R_EE_GS_CSR _ld(A_EE_GS_CSR)
// Interrupt mask
#define R_EE_GS_IMR _ld(A_EE_GS_IMR)
// Host I/F switching
#define R_EE_GS_BUSDIR _ld(A_EE_GS_BUSDIR)
